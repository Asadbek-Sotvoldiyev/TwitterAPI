...
from api.views import SendEmailRegistrationAPIView, CodeVerifyAPIView, ResendCodeAPIView, FullSignUpAPIView, \
    LoginAPIView, CreatePostAPIView, UpdateDeleteAPIView, CreateMediaAPIView, DeleteMediaAPIView
